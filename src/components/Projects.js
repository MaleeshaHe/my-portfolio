    ...
    <section id="projects" className="py-24 px-6 bg-[#050505]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-12 mb-12">
          {/* Featured Projects */}
          <div>
            <h3 className="text-2xl font-light text-white mb-8 text-center">Featured Work</h3>
          ...
          {/* Other Projects */}
          <div>
            <h3 className="text-2xl font-light text-white mb-8 text-center">More Projects</h3>
